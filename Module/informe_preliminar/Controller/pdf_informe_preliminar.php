...
class PDF extends FPDF
{
    ...
    {
        $CodigoQR   = '../../../Module/informe_preliminar/View/Img/SinImagen.jpg';
        $Imagen1    = '../../../Module/informe_preliminar/View/Img/SinImagen.jpg';
        $Imagen2    = '../../../Module/informe_preliminar/View/Img/SinImagen.jpg';
        $Imagen3    = '../../../Module/informe_preliminar/View/Img/SinImagen.jpg';
        $Imagen4    = '../../../Module/informe_preliminar/View/Img/SinImagen.jpg';
        $Mapa       = '../../../Module/informe_preliminar/View/Img/SinImagen.jpg';
        $Bus        = '../../../Module/informe_preliminar/View/Img/SinImagen.jpg';
        ...
        foreach ($pData_InformePreliminar as $row)
        {
            ...
            $this->SetFont('Arial','B',12);
            $this->SetTextColor(0);
            $this->Cell(135,6,"INFORME PRELIMINAR",0,0,'C',false);
            ...
            $this->Cell(4);
            $this->Cell(180,4,'SUSCRITO POR: '.utf8_decode($row['CGOSuscribe']).' EL '.date('d/m/Y',strtotime($row['Acci_FechaEdicion'])).'  '.date('H:i',strtotime($row['Acci_FechaEdicion'])),0,1,'L',false);
            $this->Ln(2);
            ...
            foreach($pData_Naturaleza as $row2){
                if($row2['Acci_Tipo']=='DañosPersonales'){
                    ...
                    $this->SetFont('Arial','B',6);
                    $this->MultiCell(172,4,utf8_decode($row2['Acci_Nombre']).', DNI: '.$row2['Acci_Dni'].', EDAD: '.$row2['Acci_Edad'].' '.utf8_decode('años').', GENERO: '.utf8_decode($row2['Acci_Genero']),0,'J',false); 
                    $this->SetFont('Arial','',6);
                    $this->Cell(8);
