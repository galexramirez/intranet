...
$(document).ready(function(){
  ...
  $(document).on("click", ".btn_buscar_listado_manual", function(){
    ...
    if(sel_modulo_nombre!==''){
      man_modulo_id = f_buscar_dato("Modulo", "Modulo_Id", "`Mod_NombreVista`='"+sel_modulo_nombre+"'");
  ...
  $('#form_manual_registro').submit(function(e){                         
    ...
    man_modulo_id = f_buscar_dato("Modulo", "Modulo_Id", "`Mod_NombreVista`='"+new_man_modulo_nombre+"'");
