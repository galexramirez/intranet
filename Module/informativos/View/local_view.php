<div id="contenido" class="my-contenido-con-sidebar p-0">
	...
	<div class="row p-3">
		<div class="col-auto m-0">
			<div class="table-responsive" id="div_tabla_informativo">
	...
	<!--Modal para CRUD-->
	<div class="row modal fade" id="modal_crud_informativo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog"  role="document">
			<div class="modal-content">

				<div class="modal-header">
			        <h5 class="modal-title" id="informativo_modal_label"></h5>
