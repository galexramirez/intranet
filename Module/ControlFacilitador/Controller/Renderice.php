...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="ControlFacilitador"; // Como figura en la BD
    $NombreDeModuloVista="Control Facilitador"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    ...
    $InsertHead="   <link rel='stylesheet' href='Services/Resources/jquery-ui-1.12.1/jquery-ui.min.css'>
                    <link rel='stylesheet' href='Module/ControlFacilitador/View/LocalView.css' type='text/css' media='all'>
...
*/
    ...
    $InserFooter="  <script src='Services/Resources/jquery-ui-1.12.1/jquery-ui.js'></script>
                    ...
                    <script src='Module/ControlFacilitador/View/LocalViewInicio.js' type='text/javascript'></script>
                    <script src='Module/ControlFacilitador/View/LocalViewCargaFacilitador.js' type='text/javascript'></script>
                    <script src='Module/ControlFacilitador/View/LocalViewTroncal.js' type='text/javascript'></script>  
                    <script src='Module/ControlFacilitador/View/LocalViewAlimentador.js' type='text/javascript'></script>
                    <script src='Module/ControlFacilitador/View/LocalViewNovedad.js' type='text/javascript'></script>  
                    <script src='Module/ControlFacilitador/View/LocalViewDetalleNovedad.js' type='text/javascript'></script>
                    <script src='Module/ControlFacilitador/View/LocalViewReporte.js' type='text/javascript'></script>
                    <script src='Module/ControlFacilitador/View/LocalViewTipoTabla.js' type='text/javascript'></script>
 ...
 // 4.0 CONTRUCCION DE LA VISTA
    ...
    // VISTA DEL MODULO
    MController('ControlFacilitador','Logico');
