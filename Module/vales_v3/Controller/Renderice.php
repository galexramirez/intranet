...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="vales_v3"; // Como figura en la BD
    $NombreDeModuloVista="Vales v3.0"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    ...
    $InsertHead="   <link rel='stylesheet' href='Services/Resources/jquery-ui-1.12.1/jquery-ui.css'>
                    <link rel='stylesheet' href='Module/vales_v3/View/local_view.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script src='Services/Resources/jquery-ui-1.12.1/jquery-ui.js'></script>
                    ...
                    <script src='Module/vales_v3/View/local_view_inicio.js' type='text/javascript'></script>
                    <script src='Module/vales_v3/View/local_view_vales.js' type='text/javascript'></script>
                    <script src='Module/vales_v3/View/local_view_vales_procesar.js' type='text/javascript'></script>
                    <script src='Module/vales_v3/View/local_view_vales_repuestos.js' type='text/javascript'></script> ";
