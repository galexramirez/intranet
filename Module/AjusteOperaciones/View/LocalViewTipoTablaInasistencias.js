$(document).ready(function(){
    ...
    $(document).on("click", ".btnEditarTipoTablaInasistencias", function(){
        ...
        $(".modal-header").css("color", "white" );
        $(".modal-title").text("Editar Tabla Inasistencias");		
            ...
            if (result.isConfirmed) {
                ...
                if (respuestaTablaInasistencias == 1) {            
                    ...
                    data:  { MoS:MoS,NombreMoS:NombreMoS,Accion:Accion,TtablaInasistencias_Id:TtablaInasistencias_Id },   
                        success: function(data) {
                            tablaTipoTablaInasistencias.row(fila.parents('tr')).remove().draw();
                        }
                    });
                }
            }
...
function validarTablaInasistencias(TtablaInasistencias_Id,TtablaInasistencias_Tipo,TtablaInasistencias_Operacion,TtablaInasistencias_Detalle){
    ...
    var respuestaInasistencias="";    

    return respuestaInasistencias; 
}

///::::::::: INVISIBILIZA LOS MENSAJE DE ALERTA DEL FORMULARIO :::::: /// 
function LimpiaMsTablaInasistencias(){
    $("#MsTtablaInasistencias_Id").css("display", "none" );
    $("#MsTtablaInasistencias_Tipo").css("display", "none" );
    $("#MsTtablaInasistencias_Operacion").css("display", "none" );
    $("#MsTtablaInasistencias_Detalle").css("display", "none" );
}