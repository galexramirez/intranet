...
<head>
	...
	<!-- FIN de Mata -->
  	...
  	<!-- CSS Template -->
		...
		<link rel='stylesheet'  href='Services/PlantillaTemplon/View/VistaGeneral.css' type='text/css' media='all'>  
	...
	<header>
		<nav class='fixed-top  p-0 m-0 d-flex  bg-white my-primernivel'>	
			<div class='col-7 row justify-content-star align-self-center m-0 p-0'>
				...
				<!-- LOGO -->
				<div>
					<a href='c_ModuloInicio'>
						<img src='Services/PlantillaTemplon/View/Img/logolbi2.jpg' class='my-logo'  alt=''>
					</a>
				</div>
			</div>	
			...
			<div class='col-5 d-flex row justify-content-end align-self-center m-0 p-0'>
        		<div class='align-self-center'>	
					<a href="AjusteUsuario">
						<!--<img class='rounded-circle' height='40'  src='Services/FotoPersonal/php.jpg'> -->
						<img class='rounded-circle' height='40' src='data:image/jpg;base64,<?= $FotoUsuario ?>'>
					</a>
				</div>
