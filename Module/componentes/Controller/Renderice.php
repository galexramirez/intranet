...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="componentes"; // Como figura en la BD
    $NombreDeModuloVista="Componentes"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    ...
    $InsertHead="   <link rel='stylesheet' href='Services/Resources/jquery-ui-1.12.1/jquery-ui.css'>
                    <link rel='stylesheet' href='Module/componentes/View/local_view.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script src='Services/Resources/jquery-ui-1.12.1/jquery-ui.js'></script>
                    ...
                    <script src='Module/componentes/View/local_view_inicio.js' type='text/javascript'></script>
                    <script src='Module/componentes/View/local_view_componentes.js' type='text/javascript'></script> ";
...
// 4.0 CONTRUCCION DE LA VISTA
    ...
    // VISTA DEL MODULO
    MController('componentes','Logico');
