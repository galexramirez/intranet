...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="AjusteOperaciones"; // Como figura en la BD
    $NombreDeModuloVista="Ajustes de Operaciones"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    $InsertHead="   <link rel='stylesheet' href='Module/AjusteOperaciones/View/LocalView.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script type='text/javascript' src='Services/Resources/DataTables-10.25/datatables/datatables.min.js'></script>
                    ...
                    <script src='Module/AjusteOperaciones/View/LocalViewInicio.js' type='text/javascript'></script>
                    <script src='Module/AjusteOperaciones/View/LocalViewTipoTabla.js' type='text/javascript'></script>
                    <script src='Module/AjusteOperaciones/View/LocalViewDistancias.js' type='text/javascript'></script>
                    <script src='Module/AjusteOperaciones/View/LocalViewTipoTablaAccidentes.js' type='text/javascript'></script>
                    <script src='Module/AjusteOperaciones/View/LocalViewTipoTablaComportamiento.js' type='text/javascript'></script>
                    <script src='Module/AjusteOperaciones/View/LocalViewTipoTablaInasistencias.js' type='text/javascript'></script>
                    <script src='Module/AjusteOperaciones/View/local_view_matriz_accidentes.js' type='text/javascript'></script> ";
