...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="ProgramacionCarga"; // Como figura en la BD
    $NombreDeModuloVista="Programación Carga"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    $InsertHead="   <link rel='stylesheet' href='Module/ProgramacionCarga/View/LocalView.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script type='text/javascript' src='Services/Resources/DataTables-10.25/datatables/datatables.min.js'></script>
                    ...
                    <script src='Module/ProgramacionCarga/View/LocalViewInicio.js' type='text/javascript'></script>
                    <script src='Module/ProgramacionCarga/View/LocalViewProgramacion.js' type='text/javascript'></script>
                    <script src='Module/ProgramacionCarga/View/LocalViewPublicacion.js' type='text/javascript'></script>
                    <script src='Module/ProgramacionCarga/View/LocalViewDetalle.js' type='text/javascript'></script>
                    <script src='Module/ProgramacionCarga/View/LocalViewPdf.js' type='text/javascript'></script>
                    <script src='Module/ProgramacionCarga/View/LocalViewDescargaPdf.js' type='text/javascript'></script>  ";
...
// 4.0 CONTRUCCION DE LA VISTA
    ...
    // VISTA DEL MODULO
    MController('ProgramacionCarga','Logico');
