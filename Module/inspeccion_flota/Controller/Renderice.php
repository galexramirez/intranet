...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="inspeccion_flota"; // Como figura en la BD
    $NombreDeModuloVista="Inspección de Flota"; // Como se muestra la usuario
...
//
 // 3.0 RECURSOS PARA EL MODULO     
    $InsertHead="   <link rel='stylesheet' href='Module/inspeccion_flota/View/local_view.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script type='text/javascript' src='Services/Resources/DataTables-10.25/datatables/datatables.min.js'></script>
                    ...
                    <script src='Module/inspeccion_flota/View/local_view_inicio.js' type='text/javascript'></script>
                    <script src='Module/inspeccion_flota/View/local_view_listado.js' type='text/javascript'></script>
                    <script src='Module/inspeccion_flota/View/local_view_inspeccion.js' type='text/javascript'></script>
                    <script src='Module/inspeccion_flota/View/local_view_codigo.js' type='text/javascript'></script>
                    <script src='Module/inspeccion_flota/View/local_view_componente.js' type='text/javascript'></script>
                    <script src='Module/inspeccion_flota/View/local_view_falla_accion.js' type='text/javascript'></script>
                    <script src='Module/inspeccion_flota/View/local_view_posicion.js' type='text/javascript'></script>
                    <script src='Module/inspeccion_flota/View/local_view_reporte.js' type='text/javascript'></script>
                    <script src='Module/inspeccion_flota/View/local_view_falla.js' type='text/javascript'></script>
                    <script src='Module/inspeccion_flota/View/local_view_tc_inspeccion_usuario.js' type='text/javascript'></script>
                    <script src='Module/inspeccion_flota/View/local_view_tc_inspeccion_sistema.js' type='text/javascript'></script>
...
// 4.0 CONTRUCCION DE LA VISTA
    ...
    // VISTA DEL MODULO
    MController('inspeccion_flota','Logico');
