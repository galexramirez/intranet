...
$(document).ready(function(){
    ...
    $(document).on("click", ".btn_buscar_vales", function(){		
        ...
        $("#tabla_vales").dataTable().fnDestroy();
        $('#tabla_vales').show();
    ...
    $(document).on("click", ".btn_ver_vales", function(){
        ...
        $('#iva_responsable').val(iva_responsable);
        $('#iva_obs_cgm').val(iva_obs_cgm);
        $('#iva_cierre_adm').val(iva_cierre_adm);
        $('#iva_date_cierre_adm').val(iva_date_cierre_adm);
        $('#iva_estado').val(iva_estado);
        $('#iva_garantia').val(iva_garantia);
        $('#iva_bus').val(iva_bus);
        $('#iva_estado').val(iva_estado);
        $('#iva_descrip').val(iva_descrip);
        // Se cargan los div
    ...
    $(document).on("click", ".btn_descargar_vales", function(){		
        ...
        $.ajax({
            ...
            success     : function(data){
                window.location.href = mi_carpeta + "Module/Vales/Controller/csv_descarga.php?Archivo=" + data;
            }
        });
    });
