...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="OTCorrectivas"; // Como figura en la BD
    $NombreDeModuloVista="OT Correctivas"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    $InsertHead="   <link rel='stylesheet' href='Module/OTCorrectivas/View/LocalView.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script type='text/javascript' src='Services/Resources/DataTables-10.25/datatables/datatables.min.js'></script>
                    ...
                    <script src='Module/OTCorrectivas/View/LocalViewInicio.js' type='text/javascript'></script>
                    <script src='Module/OTCorrectivas/View/LocalViewOTCorrectivas.js' type='text/javascript'></script>
                    <script src='Module/OTCorrectivas/View/LocalViewOTProcesar.js' type='text/javascript'></script>
                    <script src='Module/OTCorrectivas/View/local_view_horas_tecnicos.js' type='text/javascript'></script>
                    <script src='Module/OTCorrectivas/View/local_view_cierre_semanal.js' type='text/javascript'></script>
...
// 4.0 CONTRUCCION DE LA VISTA
    ...
    // VISTA DEL MODULO
    MController('OTCorrectivas','Logico');
