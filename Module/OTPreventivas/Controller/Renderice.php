...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="OTPreventivas"; // Como figura en la BD
    $NombreDeModuloVista="OT Preventivas"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    $InsertHead="   <link rel='stylesheet' href='Module/OTPreventivas/View/LocalView.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script type='text/javascript' src='Services/Resources/DataTables-10.25/datatables/datatables.min.js'></script>
                    ...
                    <script src='Module/OTPreventivas/View/LocalViewInicio.js' type='text/javascript'></script>
                    <script src='Module/OTPreventivas/View/LocalViewCarga.js' type='text/javascript'></script>
                    <script src='Module/OTPreventivas/View/LocalViewOTPreventivas.js' type='text/javascript'></script>
                    <script src='Module/OTPreventivas/View/LocalViewOTProcesar.js' type='text/javascript'></script>
...
// 4.0 CONTRUCCION DE LA VISTA
    ...
    // VISTA DEL MODULO
    MController('OTPreventivas','Logico');
