...
class Logico
{
    ...
    public function pdf_informe_preliminar($accidentes_id)
    {
        ...
        MModel($this->Modulo,'CRUD');
        $InstanciaAjax  = new CRUD();
        $Imagen         = $InstanciaAjax->buscar_imagen_pdf($accidentes_id);
        ...
        MModel($this->Modulo,'CRUD');
        $InstanciaAjax      = new CRUD();
        $InformePreliminar  = $InstanciaAjax->pdf_informe_preliminar($accidentes_id);
        ...
        $Naturaleza     = $InstanciaAjax->buscar_data_bd($TablaBD,$CampoBD,$accidentes_id);
        ...
        $CampoBD        = 'Accidentes_Id';
        $Reparacion     = $InstanciaAjax->buscar_data_bd($TablaBD,$CampoBD,$accidentes_id);
