<?php
require '../../../Services/Composer/vendor/autoload.php'; //Nota: si renombraste la carpeta a algo diferente de "ticket" cambia el nombre en esta línea
...
$logo = EscposImage::load('../../../Module/vales_v3/View/Img/VistaPrevia.jpg', false);
