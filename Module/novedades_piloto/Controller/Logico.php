...
class Logico
{
    ...
    public function descargar_inasistencias($fecha_inicio, $fecha_termino)
    {
        MModel($this->Modulo,'CRUD');
        $InstanciaAjax  = new CRUD();
    ...
    public function descargar_comportamiento($fecha_inicio, $fecha_termino)
    {
        MModel($this->Modulo,'CRUD');
        $InstanciaAjax  = new CRUD();
    ...
    public function descargar_accidentes($fecha_inicio, $fecha_termino)
    {
        MModel($this->Modulo,'CRUD');
        $InstanciaAjax  = new CRUD();
