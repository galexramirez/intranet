...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="Inventario"; // Como figura en la BD
    $NombreDeModuloVista="Inventario"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    ...
    $InsertHead="   <link rel='stylesheet' href='Services/Resources/jquery-ui-1.12.1/jquery-ui.css'>
                    <link rel='stylesheet' href='Module/Inventario/View/LocalView.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script src='Services/Resources/jquery-ui-1.12.1/jquery-ui.js'></script>
                    ...
                    <script src='Module/Inventario/View/local_view_inicio.js' type='text/javascript'></script>
                    <script src='Module/Inventario/View/local_view_movimiento.js' type='text/javascript'></script>
                    <script src='Module/Inventario/View/local_view_entrada.js' type='text/javascript'></script>
                    <script src='Module/Inventario/View/local_view_entrada_materiales.js' type='text/javascript'></script>
                    <script src='Module/Inventario/View/local_view_salida.js' type='text/javascript'></script>
                    <script src='Module/Inventario/View/local_view_almacen.js' type='text/javascript'></script>
                    <script src='Module/Inventario/View/local_view_material_almacen.js' type='text/javascript'></script>
                    <script src='Module/Inventario/View/local_view_reportes.js' type='text/javascript'></script> ";
