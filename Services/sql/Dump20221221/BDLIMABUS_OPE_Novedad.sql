...
--
-- Table structure for table `OPE_Novedad`
--

DROP TABLE IF EXISTS `OPE_Novedad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `OPE_Novedad` (
  `OPE_NovedadId` int NOT NULL AUTO_INCREMENT,
