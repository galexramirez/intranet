...
class PDF extends FPDF
{
    ...
    // Tabla coloreada sin Programación
    ...
    // Tabla coloreada con Programación Individual 
    public function GeneraProgramacionIndividual($data,$Dni)
    {
        $Prog_Dni="1";
        $Prog_Fecha="1";
        $Prog_HoraDestino="";
    ...
    // Tabla coloreada con Programacion General
    public function GeneraProgramacionGeneral($data)
    {
        $Prog_Dni="1";
        $Prog_Fecha="1";
        $Prog_HoraDestino="";
