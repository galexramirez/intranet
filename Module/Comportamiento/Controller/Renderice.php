...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo = "Comportamiento"; // Como figura en la BD
    $NombreDeModuloVista = "Comportamiento"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    ...
    $InsertHead="   <link rel='stylesheet' href='Module/Comportamiento/View/local_view.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script type='text/javascript' src='Services/Resources/DataTables-10.25/datatables/datatables.min.js'></script>
                    ...
                    <script src='Module/Comportamiento/View/local_view_inicio.js' type='text/javascript'></script>
                    <script src='Module/Comportamiento/View/local_view_listado.js' type='text/javascript'></script>
                    <script src='Module/Comportamiento/View/local_view_comportamiento.js' type='text/javascript'></script>                
                    <script src='Module/Comportamiento/View/local_view_telemetria_carga.js' type='text/javascript'></script>
                    <script src='Module/Comportamiento/View/local_view_reporte_gdh.js' type='text/javascript'></script>
                    <script src='Module/Comportamiento/View/LocalViewTipoTablaComportamiento.js' type='text/javascript'></script>
...
// 4.0 CONTRUCCION DE LA VISTA
    ...
    // VISTA DEL MODULO
    MController('Comportamiento','Logico');
