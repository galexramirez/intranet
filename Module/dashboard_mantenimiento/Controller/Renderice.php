...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="dashboard_mantenimiento"; // Como figura en la BD
    $NombreDeModuloVista="Dashboard Mantenimiento"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    $InsertHead="   <link rel='stylesheet' href='Module/dashboard_mantenimiento/View/local_view.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script type='text/javascript' src='Services/Resources/DataTables-10.25/datatables/datatables.min.js'></script>
                    ...
                    <script src='Module/dashboard_mantenimiento/View/local_view_inicio.js' type='text/javascript'></script>  
                    <script src='Module/dashboard_mantenimiento/View/local_view_dashboard_mantenimiento.js' type='text/javascript'></script> 
...
// 4.0 CONTRUCCION DE LA VISTA
    ...
    // VISTA DEL MODULO
    MController('dashboard_mantenimiento','Logico');
