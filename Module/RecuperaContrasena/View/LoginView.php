...
<html lang="es">
  ...
  <body class="text-center" >
    <form class="form-signin" id="formRecupera" action="RecuperaContrasena" method="post" >
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" name="Colab_Email" id="Colab_Email" class="form-control usuario" placeholder="john@example.com" required autofocus autocomplete="off">
			</div>
