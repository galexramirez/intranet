...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo         = "novedades_piloto"; // Como figura en la BD
    $NombreDeModuloVista    = "Novedades de Piloto"; // Como se muestra al usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    ...
    $InsertHead="   <link rel='stylesheet' href='Module/novedades_piloto/View/local_view.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script type='text/javascript' src='Services/Resources/DataTables-10.25/datatables/datatables.min.js'></script>
                    ...
                    <script src='Module/novedades_piloto/View/local_view_inicio.js' type='text/javascript'></script>
                    <script src='Module/novedades_piloto/View/local_view_inasistencias.js' type='text/javascript'></script>
                    <script src='Module/novedades_piloto/View/local_view_comportamiento.js' type='text/javascript'></script>
                    <script src='Module/novedades_piloto/View/local_view_accidentes.js' type='text/javascript'></script>
                    <script src='Module/novedades_piloto/View/local_view_novedad_carga.js' type='text/javascript'></script>
                    <script src='Module/novedades_piloto/View/local_view_novedad_detalle.js' type='text/javascript'></script>
 ...
 // 4.0 CONTRUCCION DE LA VISTA
    ...
    // VISTA DEL MODULO
    MController('novedades_piloto','Logico');
