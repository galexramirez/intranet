...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="Pedidos"; // Como figura en la BD
    $NombreDeModuloVista="Pedidos"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    ...
    $InsertHead="   <link rel='stylesheet' href='Services/Resources/jquery-ui-1.12.1/jquery-ui.css'>
                    <link rel='stylesheet' href='Module/Pedidos/View/local_view.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script src='Services/Resources/jquery-ui-1.12.1/jquery-ui.js'></script>
                    ...
                    <script src='Module/Pedidos/View/local_view_inicio.js' type='text/javascript'></script>
                    <script src='Module/Pedidos/View/local_view_pedido.js' type='text/javascript'></script>
                    <script src='Module/Pedidos/View/local_view_pedido_procesar.js' type='text/javascript'></script>
                    <script src='Module/Pedidos/View/local_view_material_pedido.js' type='text/javascript'></script>
                    <script src='Module/Pedidos/View/local_view_cotizacion_procesar.js' type='text/javascript'></script> 
                    <script src='Module/Pedidos/View/local_view_cotizacion_seleccion.js' type='text/javascript'></script> 
                    <script src='Module/Pedidos/View/local_view_orden_compra.js' type='text/javascript'></script> ";
