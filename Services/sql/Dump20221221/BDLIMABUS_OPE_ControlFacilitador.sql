...
--
-- Table structure for table `OPE_ControlFacilitador`
--

DROP TABLE IF EXISTS `OPE_ControlFacilitador`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `OPE_ControlFacilitador` (
  `ControlFacilitador_Id` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ControlFacilitador_Id`)
) ENGINE=InnoDB AUTO_INCREMENT=117569 DEFAULT CHARSET=utf8mb3;
