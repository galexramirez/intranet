...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="AjusteMantenimiento"; // Como figura en la BD
    $NombreDeModuloVista="Ajustes de Mantenimiento"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    $InsertHead="   <link rel='stylesheet' href='Module/AjusteMantenimiento/View/LocalView.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script type='text/javascript' src='Services/Resources/DataTables-10.25/datatables/datatables.min.js'></script>
                    ...
                    <script src='Module/AjusteMantenimiento/View/LocalViewInicio.js' type='text/javascript'></script>
                    <script src='Module/AjusteMantenimiento/View/LocalViewTipoTablaOTPreventivas.js' type='text/javascript'></script>
                    <script src='Module/AjusteMantenimiento/View/LocalViewTipoTablaOTCorrectivas.js' type='text/javascript'></script>
                    <script src='Module/AjusteMantenimiento/View/LocalViewAsociados.js' type='text/javascript'></script>
                    <script src='Module/AjusteMantenimiento/View/LocalViewOrigenes.js' type='text/javascript'></script>
                    <script src='Module/AjusteMantenimiento/View/LocalViewTipoTablaVales.js' type='text/javascript'></script>
                    <script src='Module/AjusteMantenimiento/View/local_view_unidad_medida.js' type='text/javascript'></script>
                    <script src='Module/AjusteMantenimiento/View/LocalViewTipoTablaMateriales.js' type='text/javascript'></script>
                    <script src='Module/AjusteMantenimiento/View/LocalViewTipoTablaPedidos.js' type='text/javascript'></script>
                    <script src='Module/AjusteMantenimiento/View/local_view_tc_inventario.js' type='text/javascript'></script>
                    <script src='Module/AjusteMantenimiento/View/local_view_tc_componente.js' type='text/javascript'></script>
                    <script src='Module/AjusteMantenimiento/View/local_view_tc_inspeccion.js' type='text/javascript'></script>";
