...
// Busca la semana publicada vigente
MModel('ProgramacionCarga','CRUD');
$InstanciaAjax= new CRUD();
$Semana=$InstanciaAjax->BuscarSemanaPublicada($Semana);
...
if($Semana==""){ 
    ...
    // Registra descarga de PDF
    $InstanciaAjax->CrearRegistroDescarga($Dni);
    }
