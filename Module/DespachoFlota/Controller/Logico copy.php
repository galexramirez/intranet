			...
			$html .=	'<div class="card '.$colorBorder.'">
							<div class="card-header '. $colorHeader .'">
								<div class="d-flex justify-content-between">
									...
									<div class="p2">
										<h1 class="card-title text-right"> '. $row["Prog_Bus"] . '</h1>
									</div>
								</div>
							</div>
							<div class="card-body card-block">
								<ul class="list-inline">
									...
									<li> CODIGO : ' . $row["Prog_CodigoColaborador"] . '</li>
									<li> PILOTO : <h5><b>' . $row["Prog_NombreColaborador"] . '</b></h5></li>
								</ul>
								<ul class="list-inline">
									<li><i class="fa fa-clock" style="font-size:24"></i></li>
									<li> HORA DE MANTENIMIENTO : ' . $row["Prog_HoraMantenimiento"] .'</li>
									<li> HORA DE ORIGEN : ' . $row["Prog_HoraOrigen"] .'</li>
									<li> HORA DE DESTINO : <h5><b>' . $row["Prog_HoraDestino"] .'</b></h5></li>
								</ul>
